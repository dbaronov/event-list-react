...
export const EventList = () => {
    ...
    <div className="app events">
        ...
        <div className="events_text-input">
            ...
            <input type="text" placeholder="Search events" onChange={e => setSearchInput(e.target.value)} >
            </input>
        ...
        { filtersVisible && <TagFiltersSection checked = {false} tags = {data.tagFilters} selected={selectedTags} setSelected={setSelectedTags}  /> }
        </div>
